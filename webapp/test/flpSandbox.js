		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Supplier&#x27;s Matrix of Responsibility",
									"targetURL": "#comkposuppliersmatrixofresponsibility-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comkposuppliersmatrixofresponsibility-display": {
								"semanticObject": "comkposuppliersmatrixofresponsibility",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.kpo.suppliersmatrixofresponsibility",
									"url": sap.ui.require.toUrl("com/kpo/suppliersmatrixofresponsibility")
								}
							}
						}
					}
